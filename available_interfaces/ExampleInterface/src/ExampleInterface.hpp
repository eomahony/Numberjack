...
public:
     ...
     */
    ExampleInterface_IntVar(const int lb, const int ub, const int ident) : ExampleInterface_Expression(lb, ub) {
        nbj_ident = ident;
    }
     ...
     */
    ExampleInterface_IntVar(ExampleInterfaceIntArray& vals, const int ident) : ExampleInterface_Expression(vals) {
        nbj_ident = ident;
    }
