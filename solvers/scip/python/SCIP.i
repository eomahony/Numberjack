/* File: SCIP.i, generated by mk_interface.py */
%module SCIP 
...
%template(SCIPExpArray) SCIPArray< SCIP_Expression* >;
%template(SCIPIntArray) SCIPArray< int >;
%template(SCIPDoubleArray) SCIPArray< double >;
